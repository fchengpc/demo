...
async function getIntrospectionQueryResultData({ apiEndpoint, graphql, accessToken }) {
    try {
    ...
    return getRef({ apiEndpoint, accessToken })
        .then((ref) => {
...
export async function getStaticProps({
 ...
 const schema = await getIntrospectionQueryResultData({
     'https://onelasttime.cdn.prismic.io/graphql',
