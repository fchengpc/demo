...
import DynamicTheme from "../src/theme";
import {
    InMemoryCache,
    IntrospectionFragmentMatcher,
} from "apollo-cache-inmemory";
import { PrismicLink } from "../src/lib/PrismicLink";
import cookies from "next-cookies";
import { RestLink } from "apollo-link-rest";
import { RetryLink } from "apollo-link-retry";
import { ApolloLink } from "apollo-link";
import { HttpLink } from "apollo-link-http";
import { SharedStateProvider, DOMProvider } from "../src/lib/SharedState";
import Router from "next/router";
import * as gtm from "../src/lib/gtm";
import { MochaRestLink } from "../src/lib/MochaRestLink";
...
let config; //save config from server execution for future client execution
